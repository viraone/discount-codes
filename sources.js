...
const SOURCES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Best Buy", url: "https://www.bestbuy.com/site/searchpage.jsp?st={q}", top: true },
      { name: "Best Buy Open-Box", url: "https://www.bestbuy.com/site/searchpage.jsp?st={q}&qp=condition_facet%3DCondition~Open-Box" },
      { name: "Best Buy Outlet", url: "https://www.bestbuy.com/site/misc/deal-of-the-day/pcmcat248000050016.c?id=pcmcat248000050016" },
      { name: "Amazon", url: "https://www.amazon.com/s?k={q}&rh=p_89%3ASony", top: true },
      { name: "Amazon Warehouse (used/open-box)", url: "https://www.amazon.com/s?k={q}&rh=p_n_condition-type%3A6461716011" },
      ...
      { name: "B&H Photo", url: "https://www.bhphotovideo.com/c/search?q={q}" },
      ...
      { name: "Newegg", url: "https://www.newegg.com/p/pl?d={q}" },
      { name: "eBay (Sony official outlet too)", url: "https://www.ebay.com/sch/i.html?_nkw={q}&LH_ItemCondition=1000%7C1500%7C2000%7C2500" },
  ...
  },
  {
    ...
    items: [
      { name: "Google Shopping", url: "https://www.google.com/search?tbm=shop&q={q}", top: true },
